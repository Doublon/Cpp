...
{ 
  ...
  cout << "********************************************************************" << endl;
  {
    Couleur c;
    {
      ...
      cout << "c1 : "; c1.Affiche();
      cout << "Luminance de c1 : " << c1.getLuminance() << endl;
    ...
    cout << "c : "; c.Affiche();
    cout << "Luminance de c1 : " << c.getLuminance() << endl;
  }
}
...
void Essai5()
{
  ...
  cout <<         "(5) ***** Tests des operateurs < > et == de Couleur ****************" << endl;
  cout <<         "********************************************************************" << endl;
  Couleur c1(109,7,26,"Bordeaux"),c2(233,56,63,"Grenadine");
  cout << "c1 = "; c1.Affiche();
  cout << "Luminance de c1 = " << c1.getLuminance() << endl;
  cout << "c2 = "; c2.Affiche();
  cout << "Luminance de c2 = " << c2.getLuminance() << endl;
  cout << endl;
